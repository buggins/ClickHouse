...
SET param_strict_user_05055 = 'user_05055_$';
SET enforce_strict_identifier_format = 1;
CREATE USER `user_05055_$`; -- { serverError BAD_ARGUMENTS }
CREATE USER {strict_user_05055:Identifier}; -- { serverError BAD_ARGUMENTS }
CREATE ROLE {strict_user_05055:Identifier}; -- { serverError BAD_ARGUMENTS }
GRANT SELECT ON *.* TO {strict_user_05055:Identifier}; -- { serverError BAD_ARGUMENTS }
DROP ROLE {strict_user_05055:Identifier}; -- { serverError BAD_ARGUMENTS }
